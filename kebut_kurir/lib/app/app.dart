...
class _AppMainState extends State<AppMain> {
  ...
  Future<void> initSecurityState() async {
    FreeraspConfig().initSecurity(expectedPackageName: 'com.example.kebut_kurir', expectedSigningCertificateHash: base64Hash, supportedAlternativeStores: <String>['com.sec.android.app.samsungapps'], watcherMail: 'yerikhosutandi0@gmail.com', iosAppBundleId: 'com.example.kebut_kurir', iosAppTeamId: 'Q3F7R3QAGK');
  }

  Future<void> initDinamycLinks() async {
    // dynamicLinks.onLink.listen((dynamicLinkData) async {
    //   print('DYNAMIC LINK DATA ${dynamicLinkData.link.toString()}');
    //   Get.toNamed(
