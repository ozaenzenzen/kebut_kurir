...
class STNKKendaraanLivenessController extends GetxController {
  ...
  void onTakePictureButtonPressed() {
    ...
    takePicture().then(
      (XFile? file) async {
        ...
        Get.toNamed(
          Routes.stnkKendaraanLivenessResultScreen,
          arguments: STNKKendaraanArgs(
            compressedFile: compressedFile,
            file: tempImage,
          ),
        );
        // Get.back(
        //   result: compressedFile.path
        // );
      },
    );
  }
