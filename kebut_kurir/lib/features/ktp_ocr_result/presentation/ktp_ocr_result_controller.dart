...
class KTPOcrResultController extends GetxController {
  ...
  String normalizeLahirText(String text) {
    ...
    result = result.replaceAll('GLAHIR', '').replaceAll('LAHIR', '').replaceAll('/TGL', '').replaceAll('/TL', '').replaceAll('TL', '').replaceAll('TMPT', '').replaceAll('TPT', '').replaceAll('TEMPAT', '').replaceAll(',', '').replaceAll(' :', '').replaceAll(': ', '').trim();
  ...
  String normalizeJenisKelaminText(String text) {
    ...
    result = result.replaceAll('GOL. DARAHO', '').replaceAll('GOL. DARAH', '').replaceAll('GOL DARAH', '').replaceAll('LAKFEARI', '').replaceAll('LAKFLAK', '').replaceAll('KELAMIN', '').replaceAll('KEIAMIN', '').replaceAll('JENIS', '').replaceAll('DENIS', '').replaceAll('DARAH ', '').replaceAll('ENIS', '').replaceAll('DARA', '').replaceAll('GO', '').replaceAll('L. ', '').replaceAll(' H0', '').replaceAll(' HO', '').replaceAll(':', '').replaceAll(' :', '').replaceAll(' 0', '').replaceAll(' O', '').trim();

    if (result.contains('LAK-LAK') || result == 'LAKI-LAK' || result == 'AK-LAK' || result == 'LAKFLAKI' || result == 'LAKHLAK' || result == 'LAKFEAKI' || result == 'LAKELAKI' || result == 'LAKELAK' || result == 'LAKHLAKI' || result == 'LAKHEAK' || result == 'LAK-LAKI' || result == 'LAKHEAKI' || result == 'LAKIFEAK' || result == 'LAKFEAKE' || result == 'LAKIFEAKI' || result == 'LAKFEAR' || result == 'LAKFLAK' || result == 'LAK-LAKE' || result == 'LAK-EAK' || result.contains('LA') || result == 'LAK-EAKI' || result.contains('L') || result == 'LAKELAKE') {
      return 'Laki-Laki';
    }
    if (result == 'PEREM' || result == 'PUAN' || result == 'PER' || result == 'PERU' || result == 'PU' || result == 'PERI' || result == 'PERA' || result == 'RE' || result == 'PEREH' || result == 'PRH' || result == 'PRHA' || result == 'PHUAN' || result == 'EREM' || result == 'REHN' || result == 'MPUAN' || result.contains('P') || result.contains('PE') || result == 'PEA' || result == 'PERHUAN' || result == 'PRUMPAN' || result == 'EMPUAN' || result == 'RUMPUAN' || result == 'HAMPUAN' || result == 'REMPUN') {
      return 'Perempuan';
    }
  ...
  String normalizeAlamatText(String text) {
    ...
    result = result.replaceAll('RI/KEILDESAA', '').replaceAll('RTKELIIDESAA', '').replaceAll('TIKEL/LDESA', '').replaceAll('RTKEL/DESAA', '').replaceAll('RTKELVDESA', '').replaceAll('RIKELBESAA', '').replaceAll('KECAMATAN', '').replaceAll('KEL/DESSA', '').replaceAll('KELIDESAA', '').replaceAll('KELI/DESA', '').replaceAll('KELILDESA', '').replaceAll('KELIIDESA', '').replaceAll('KELILDESA', '').replaceAll('KEL/ DESA', '').replaceAll('KELLIDESA', '').replaceAll('KECAMATDN', '').replaceAll('HECAMATAN', '').replaceAll('KEILIBESA', '').replaceAll('KELILBESA', '').replaceAll('NECAMATAN', '').replaceAll('KELL/DESA', '').replaceAll('KEL/DESAA', '').replaceAll('KELLDESAA', '').replaceAll('KEL/DESA', '').replaceAll('KELLIBES', '').replaceAll('KEI/DESA', '').replaceAll('HELLDESA', '').replaceAll('KELIBESA', '').replaceAll('KELLBESA', '').replaceAll('KEL/DESA', '').replaceAll('KELLDESA', '').replaceAll('KEILDESA', '').replaceAll('KEILBESA', '').replaceAll('KELIDESA', '').replaceAll('KEVDESA', '').replaceAll('KEVBESA', '').replaceAll('KELBESA', '').replaceAll('KE/DESA', '').replaceAll('ELLDESA', '').replaceAll('KELDESA', '').replaceAll('ALAMAT', '').replaceAll('LAMAT', '').replaceAll('RTIRW', '').replaceAll('RT/RW', '').replaceAll('ELDESA', '').replaceAll('KEVDES', '').replaceAll('RTIRWN', '').replaceAll(' TIA ', ' ').replaceAll('RT ', '').replaceAll('RT/ ', '').replaceAll('RW ', '').replaceAll(':', '').replaceAll('=', '').replaceAll('  ', ' ').trim();
  ...
  String normalizeKawinText(String text) {
    ...
    result = result.replaceAll('PERKAWINAN', '').replaceAll('PERKAWINA', '').replaceAll('STATUS', '').replaceAll('TATUS', '').replaceAll('Perkawinar', '').replaceAll('Status Perkawinar', '').replaceAll('STAFUS', '').replaceAll('R ', '').replaceAll('R', '').replaceAll('T ', '').replaceAll(':', '').trim();
  ...
  String normalizeAgamaText(String text) {
    ...
    if (result == 'SLAM' || result == 'AM' || result == 'SLA AM' || result == 'ISLU AM' || result == 'SL LAM' || result == 'ISLAME' || result == 'SLA M' || result == 'ISL AM' || result == 'ISLA AM' || result == 'S AM' || result == 'SLL AM' || result == 'SL AM' || result == 'SE AM' || result == '1SLAM' || result == 'ISLAMM' || result == 'SLA' || result == 'LAM') {
      result = 'Islam';
    }
    print(result);
