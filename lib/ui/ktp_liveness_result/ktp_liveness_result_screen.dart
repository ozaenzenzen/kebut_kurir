...
class KTPLivenessResultScreen extends GetView<KTPLivenessResultController> {
  const KTPLivenessResultScreen({super.key});
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Obx(
              () => controller.livenessImage.value == null
                  ? Container()
                  : ClipRRect(
                      borderRadius: BorderRadius.circular(12),
                      child: Image.file(
                        File(controller.livenessImage.value!.path),
                        width: 280.w,
                        height: 355.h,
                        fit: BoxFit.fitWidth,
                      ),
          ...
          children: <Widget>[
            ...
            ButtonCustom(
              ...
              onTap: () {
                Get.back();
                Get.back(
                  result: controller.livenessImage.value?.path ?? '',
                );
                // Get.offAndToNamed(
                //   Routes.ktpGuide,
                ...
                //     liveness: controller.livenessImage,
                //   ),
                // );
              },
              // withBorder: true,
