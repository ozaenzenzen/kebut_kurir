...
class STNKKendaraanLivenessResultScreen extends GetView<STNKKendaraanLivenessResultController> {
  const STNKKendaraanLivenessResultScreen({super.key});
          ...
          children: <Widget>[
            ...
            ButtonCustom(
              ...
              onTap: () {
                Get.back();
                Get.back(
                  result: controller.file.value?.path ?? '',
                );
              },
              // withBorder: true,
              textColor: AppTheme.colors.blackColor2,
