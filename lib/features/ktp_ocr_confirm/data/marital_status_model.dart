class MaritalStatusModel {
  ...
  MaritalStatusModel({this.status, this.result});
...
class Result {
  ...
  Result.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        data!.add(new MaritalStatusData.fromJson(v));
      });
    }
  }
...
class MaritalStatusData {
  ...
  MaritalStatusData({this.uuid, this.name});

  MaritalStatusData.fromJson(Map<String, dynamic> json) {
    uuid = json['uuid'];
    name = json['name'];
  }
