...
class SIMLivenessResultController extends GetxController {
  ...
  void onInit() {
    ...
    if (Get.arguments != null) {
      if (Get.arguments is SIMLivenessResultArgs) {
        final SIMLivenessResultArgs? args = Get.arguments as SIMLivenessResultArgs?;
        if (args != null) {
          card = args.card;
